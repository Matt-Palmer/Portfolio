        ...
        <section id="albums" class="light">
            ...
            <?php
                ...
                if(isset($_GET['album'])){
                    ...
                    echo "<h3 id='test'>$title</h3>";

                    echo "<div class='my-gallery' itemscope itemtype='http://schema.org/ImageGallery'>";

                    while($album_images = mysqli_fetch_assoc($get_album_images_query)){

                        $image = $album_images['image_one'];
                    
                       
            
            ?>
                        <figure itemprop="associatedMedia" itemscope itemtype="http://schema.org/ImageObject">
                            <a href="images/<?php echo $image ?>" itemprop="contentUrl" data-size="600x400">
                                <img src="images/<?php echo $image ?>" width="100" height="50" itemprop="thumbnail" alt="Image description" />
                            </a>
